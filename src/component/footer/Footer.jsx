const Footer = () => {
  return (
    <div className="mt-56">
      <footer className="bg-[#2b97a4] text-white py-10">
        <div className="mx-auto px-6 lg:px-20 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div>
            ...
            <p className="text-sm">© 2024 Syed Rakib Hasan. All rights reserved.</p>
          </div>
          ...
          <div>
            ...
            <div className="flex space-x-4">
              ...
              <a href="https://facebook.com/your-facebook" aria-label="Facebook">
                <svg
                  className="w-6 h-6 fill-current text-white hover:text-gray-300 transition-all"
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 24 24"
              ...
              <a href="https://your-portfolio.com" aria-label="Portfolio">
                <svg
                  className="w-6 h-6 fill-current text-white hover:text-gray-300 transition-all"
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 24 24"
                >
                  <path d="M12 0C5.373 0 0 5.373 0 12c0 5.327 3.438 9.83 8.205 11.385.6.111.82-.26.82-.577V19.26c-3.339.725-4.033-1.414-4.033-1.414-.546-1.387-1.333-1.757-1.333-1.757-1.091-.746.084-.73.084-.73 1.206.084 1.839 1.243 1.839 1.243 1.07 1.832 2.809 1.304 3.496.997.107-.775.42-1.304.764-1.603-2.665-.307-5.467-1.335-5.467-5.934 0-1.312.468-2.386 1.24-3.226-.125-.307-.538-1.54.115-3.213 0 0 1.01-.324 3.3 1.229.96-.267 1.983-.4 3.003-.405 1.02.005 2.045.138 3.005.405 2.288-1.553 3.297-1.229 3.297-1.229.655 1.673.242 2.906.118 3.214.773.84 1.239 1.914 1.239 3.226 0 4.602-2.807 5.611-5.481 5.911.43.372.817 1.104.817 2.223v3.293c0 .319.215.693.825.575C20.565 22.092 24 17.592 24 12 24 5.373 18.627 0 12 0z" />
                </svg>
              </a>
            </div>
          </div>
